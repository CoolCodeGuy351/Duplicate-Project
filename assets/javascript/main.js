...
$(document).ready(function() {
    ...
    var userProfile = [/* GENRE , INDIE , DATE RANGE1(YEAR) , DATERANGE2(YEAR) , CALIBUR1(6.0), CALIBUR2(9.0), RATING(G), RATING(PG), RATING(R) */];
    ...
    function questionFour(){
        ...
        var buttonRatingOne = $('<button>').addClass('question-five-button').text('G')/*.attr("value", any)*/;
        var buttonRatingTwo = $('<button>').addClass('question-five-button').text('PG')/*.attr("value", bad)*/;
        var buttonRatingThree = $('<button>').addClass('question-five-button').text('PG-13')/*.attr("value", crowd)*/;
        var buttonRatingFour = $('<button>').addClass('question-five-button').text('R')/*.attr("value", critically)*/;
